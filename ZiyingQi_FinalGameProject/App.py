...
from helperSpirit import helperSpirit
...
def onAppStart(app):
    ...
    app.r = 20
    app.dotBorder = None
    app.spirit = helperSpirit('yellow', 20, 20)
    # app.platform = Obstacles(recLeft, recTop, recWidth, recHeight, reccolor)
    # app.buttom = Button

#_______________Background______________________________________________________
